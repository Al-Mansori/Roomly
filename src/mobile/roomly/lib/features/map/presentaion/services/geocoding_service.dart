...
class GeocodingService {
  ...
  /// البحث عن مواقع متعددة بناءً على النص
  Future<List<SearchLocationResult>> searchLocations(String query) async {
    try {
      ...
      for (Location location in locations) {
        // الحصول على العنوان المفصل لكل موقع
  ...
  /// الحصول على إحداثيات الموقع الافتراضي (الدقي)
  Future<LocationCoordinates> getDokkiCoordinates() async {
    try {
      ...
      // إذا فشل البحث، استخدم الإحداثيات المعروفة للدقي
