...
class SecureStorageAddressServices {
  ...
  Future<void> saveUserPosition(Position position) async {
    await saveUserLatitude(position.latitude);
    await saveUserLongitude(position.longitude);
  }
  Future<Position?> getUserPosition() async {
    ...
    if (latitude != null && longitude != null) {
      return Position(
        ...
        heading: 0.0,
        speed: 0.0,
        speedAccuracy: 0.0, altitudeAccuracy: 1, headingAccuracy: 1,
      );
    }
