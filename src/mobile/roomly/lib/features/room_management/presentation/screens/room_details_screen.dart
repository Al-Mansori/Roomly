...
class RoomDetailsScreen extends StatefulWidget {
  ...
  const RoomDetailsScreen({Key? key, required this.roomId, this.workspaceId})
      : super(key: key);
      ...
      listener: (context, state) {
        if (state is RoomDetailsLoaded) {
          setState(() {
            ...
            _isRecoveryMode = state.isRecoveryMode;
          });
        }
      },
      child: Scaffold(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...offers
                                .map((offer) => _buildOfferCard(
                                    offer, room.pricePerHour ?? 0.0))
                                .toList(),
                          ],
                        ),
                      ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          BlocBuilder<WorkspaceDetailsCubit,
                            ...
                            builder: (context, state) {
                              if (state is WorkspaceDetailsLoaded) {
                                ...
                                print(
                                    'WorkspaceDetailsScreen - Workspace type: ${workspace.runtimeType}');
                                print(
                                    'WorkspaceDetailsScreen - Workspace address: ${workspace.address}');

                                // Check if workspace is a WorkspaceModel with location
                                if (workspace is WorkspaceModel) {
                                  print(
                                      'WorkspaceDetailsScreen - WorkspaceModel location: ${workspace.location}');
                                  if (workspace.location != null) {
                                    print(
                                        'WorkspaceDetailsScreen - Location latitude: ${workspace.location!.latitude}');
                                    print(
                                        'WorkspaceDetailsScreen - Location longitude: ${workspace.location!.longitude}');
                                    print(
                                        'WorkspaceDetailsScreen - Location id: ${workspace.location!.id}');
                                    print(
                                        'WorkspaceDetailsScreen - Location city: ${workspace.location!.city}');
                                    print(
                                        'WorkspaceDetailsScreen - Location country: ${workspace.location!.country}');
                                    ...
                                    print(
                                        'WorkspaceDetailsScreen - Location is null');
                                  ...
                                  print(
                                      'WorkspaceDetailsScreen - Workspace is not WorkspaceModel, type: ${workspace.runtimeType}');
          ...
          builder: (context, state) {
            if (state is RoomDetailsLoaded) {
              ...
              final hasActiveOffer =
                  offers.any((offer) => offer.status.toLowerCase() == 'active');
              final activeOffer = hasActiveOffer
                  ? offers.firstWhere(
                    ...
                    child: Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (_isRecoveryMode) {
                              // Do nothing when in maintenance mode
                              return;
                            }
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _isRecoveryMode
                                ...
                                : (room.availableCount ?? 0) > 0
                                    ? Colors.blue
                                    : Colors
                                        .grey, // red -> maintenance, blue -> bookable, grey -> no seats
                            padding: const EdgeInsets.symmetric(
